...
local Window = Library:CreateWindow("Exemin HUB", Vector3.new(552,668,622), Enum.KeyCode.RightControl)
...
testSection:AddButton("Esp|Team Viewer", function(IhateGayPeople)
...
local VisualTab = Window:CreateTab("Hide And Seek Extreme") --you can rename this tab to whatever you want --you can also change the tabs code, for example "AimingTab" can be changed to "FunnyCoolTab" etc.

local testSection = VisualTab:CreateSector("Humanoid", "left")
...
local testSection = VisualTab:CreateSector("Game Misc", "left")  --you can  change the section code, for example "testsection" can be changed to "FunnyCoolSection" etc.

testSection:AddButton("Collect All Coins", function(IhateGayPeople)
...
local testSection = VisualTab:CreateSector("Teleport To Safe Place", "right")  --you can  change the section code, for example "testsection" can be changed to "FunnyCoolSection" etc.

testSection:AddDropdown("Teleport", {"None", "Safe Place"}, "None", true, function(dropdown)
    if dropdown == "None" then
    print("None Selected")
    elseif dropdown == "Safe Place" then
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Lobby.Part.CFrame
end
end)

local testSection = VisualTab:CreateSector("Trolling", "right")  --you can  change the section code, for example "testsection" can be changed to "FunnyCoolSection" etc.
...
local testSection = VisualTab:CreateSector("Esp", "right")  --you can  change the section code, for example "testsection" can be changed to "FunnyCoolSection" etc.
...
local testSection = VisualTab:CreateSector("Misc", "right")  --you can  change the section code, for example "testsection" can be changed to "FunnyCoolSection" etc.
